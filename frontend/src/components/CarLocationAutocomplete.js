...
const CarLocationAutocomplete = ({
    ...
    const searchLocations = async (searchTerm) => {
        ...
        setIsLoading(true);
        try {
            const response = await carsAPI.searchLocations(searchTerm);
                    ...
                    {suggestions.map((location, index) => (
                        ...
                        >
                            <div className="airport-suggestion-content">
                                ...
                                <span className="airport-label">{location.label || location.name || location.value}</span>
                            </div>
                        </li>
                    ))}
                </ul>
...
export default CarLocationAutocomplete;
