-- Add 2025 flights for roundtrip searches
-- Run this if your database doesn't have 2025 flights

USE kayak_db;

-- 2025 Flights: Outbound flights: New York to Los Angeles (Dec 20-25, 2025)
